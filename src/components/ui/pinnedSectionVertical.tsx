...
const PinnedSectionVertical = () => {
    ...
    useIsomorphicLayoutEffect(() => {
        ...
        const contentAnimation = ScrollTrigger.create({
        ...
        const galleryAnimation = gsap.from(galleryBorder.current, {
            scrollTrigger: {
                trigger: container.current,
                start: "top top",
                end: "bottom bottom",
        ...
        //Heading Animation
        const headingAnimation = gsap.from(heading.current, {
            opacity: 0,
            x: -200,
            scrollTrigger: {
                trigger: container.current,
        ...
        const descriptionAnimation = gsap.from(description.current, {
            opacity: 0,
            y: -200,
            delay: 3,
            scrollTrigger: {
